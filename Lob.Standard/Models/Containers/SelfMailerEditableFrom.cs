...
namespace Lob.Standard.Models.Containers
{
    ...
    /// </summary>
    [JsonConverter(
        typeof(UnionTypeConverter<SelfMailerEditableFrom>),
        new Type[] {
            typeof(MStringCase),
    ...
    public abstract class SelfMailerEditableFrom
    {
        ...
        /// </summary>
        /// <returns>
        /// The SelfMailerEditableFrom instance, wrapping the provided string value.
        /// </returns>
        public static SelfMailerEditableFrom FromString(string mString)
        {
        ...
        /// </summary>
        /// <returns>
        /// The SelfMailerEditableFrom instance, wrapping the provided InlineAddressUs value.
        /// </returns>
        ...
        private sealed class MStringCase : SelfMailerEditableFrom, ICaseValue<MStringCase, string>
        {
        ...
        private sealed class InlineAddressUsCase : SelfMailerEditableFrom, ICaseValue<InlineAddressUsCase, InlineAddressUs>
        {
