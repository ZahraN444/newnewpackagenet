...
namespace Lob.Standard.Models.Containers
{
    ...
    /// </summary>
    [JsonConverter(
        typeof(UnionTypeConverter<CheckEditablePropsFrom>),
        new Type[] {
            typeof(MStringCase),
    ...
    public abstract class CheckEditablePropsFrom
    {
        /// <summary>
        /// This is String case.
        /// </summary>
        /// <returns>
        /// The CheckEditablePropsFrom instance, wrapping the provided string value.
        /// </returns>
        public static CheckEditablePropsFrom FromString(string mString)
        {
        ...
        /// </summary>
        /// <returns>
        /// The CheckEditablePropsFrom instance, wrapping the provided InlineAddressUs value.
        /// </returns>
        public static CheckEditablePropsFrom FromInlineAddressUs(InlineAddressUs inlineAddressUs)
        {
        ...
        private sealed class MStringCase : CheckEditablePropsFrom, ICaseValue<MStringCase, string>
        {
        ...
        private sealed class InlineAddressUsCase : CheckEditablePropsFrom, ICaseValue<InlineAddressUsCase, InlineAddressUs>
        {
