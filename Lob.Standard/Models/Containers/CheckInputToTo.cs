...
namespace Lob.Standard.Models.Containers
{
    ...
    /// </summary>
    [JsonConverter(
        typeof(UnionTypeConverter<CheckInputToTo>),
        new Type[] {
            typeof(MStringCase),
            typeof(Case1)
        },
    ...
    public abstract class CheckInputToTo
    {
        /// <summary>
        /// This is String case.
        /// </summary>
        /// <returns>
        /// The CheckInputToTo instance, wrapping the provided string value.
        /// </returns>
        public static CheckInputToTo FromString(string mString)
        {
        ...
        /// </summary>
        /// <returns>
        /// The CheckInputToTo instance, wrapping the provided InlineAddressUsChk11 value.
        /// </returns>
        public static CheckInputToTo FromInlineAddressUsChk11(InlineAddressUsChk11 inlineAddressUsChk11)
        {
        ...
        private sealed class MStringCase : CheckInputToTo, ICaseValue<MStringCase, string>
        {
        ...
        private sealed class Case1 : CheckInputToTo, ICaseValue<Case1, InlineAddressUsChk11>
        {
