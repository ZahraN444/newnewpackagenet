...
namespace Lob.Standard.Models.Containers
{
    ...
    /// </summary>
    [JsonConverter(
        typeof(UnionTypeConverter<ImageatcheckbottomFrom>),
        new Type[] {
            typeof(MStringCase),
    ...
    public abstract class ImageatcheckbottomFrom
    {
        /// <summary>
        /// This is String case.
        /// </summary>
        /// <returns>
        /// The ImageatcheckbottomFrom instance, wrapping the provided string value.
        /// </returns>
        public static ImageatcheckbottomFrom FromString(string mString)
        {
        ...
        /// </summary>
        /// <returns>
        /// The ImageatcheckbottomFrom instance, wrapping the provided InlineAddressUs value.
        /// </returns>
        public static ImageatcheckbottomFrom FromInlineAddressUs(InlineAddressUs inlineAddressUs)
        {
        ...
        private sealed class MStringCase : ImageatcheckbottomFrom, ICaseValue<MStringCase, string>
        {
        ...
        private sealed class InlineAddressUsCase : ImageatcheckbottomFrom, ICaseValue<InlineAddressUsCase, InlineAddressUs>
        {
