...
namespace Lob.Standard.Models.Containers
{
    ...
    /// </summary>
    [JsonConverter(
        typeof(UnionTypeConverter<ImageatcheckbottomTo>),
        new Type[] {
            typeof(MStringCase),
            typeof(Case1)
        },
    ...
    public abstract class ImageatcheckbottomTo
    {
        ...
        /// </summary>
        /// <returns>
        /// The ImageatcheckbottomTo instance, wrapping the provided string value.
        /// </returns>
        public static ImageatcheckbottomTo FromString(string mString)
        {
        ...
        /// </summary>
        /// <returns>
        /// The ImageatcheckbottomTo instance, wrapping the provided InlineAddressUsChk11 value.
        /// </returns>
        public static ImageatcheckbottomTo FromInlineAddressUsChk11(InlineAddressUsChk11 inlineAddressUsChk11)
        {
        ...
        private sealed class MStringCase : ImageatcheckbottomTo, ICaseValue<MStringCase, string>
        {
        ...
        private sealed class Case1 : ImageatcheckbottomTo, ICaseValue<Case1, InlineAddressUsChk11>
        {
