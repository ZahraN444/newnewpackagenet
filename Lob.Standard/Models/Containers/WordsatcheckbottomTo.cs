...
namespace Lob.Standard.Models.Containers
{
    ...
    /// </summary>
    [JsonConverter(
        typeof(UnionTypeConverter<WordsatcheckbottomTo>),
        new Type[] {
            typeof(MStringCase),
            typeof(Case1)
        },
    ...
    public abstract class WordsatcheckbottomTo
    {
        /// <summary>
        /// This is String case.
        /// </summary>
        /// <returns>
        /// The WordsatcheckbottomTo instance, wrapping the provided string value.
        /// </returns>
        public static WordsatcheckbottomTo FromString(string mString)
        {
        ...
        /// </summary>
        /// <returns>
        /// The WordsatcheckbottomTo instance, wrapping the provided InlineAddressUsChk11 value.
        /// </returns>
        public static WordsatcheckbottomTo FromInlineAddressUsChk11(InlineAddressUsChk11 inlineAddressUsChk11)
        {
        ...
        private sealed class MStringCase : WordsatcheckbottomTo, ICaseValue<MStringCase, string>
        {
        ...
        private sealed class Case1 : WordsatcheckbottomTo, ICaseValue<Case1, InlineAddressUsChk11>
        {
