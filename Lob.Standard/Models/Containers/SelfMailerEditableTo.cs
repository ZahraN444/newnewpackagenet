...
namespace Lob.Standard.Models.Containers
{
    ...
    /// </summary>
    [JsonConverter(
        typeof(UnionTypeConverter<SelfMailerEditableTo>),
        new Type[] {
            typeof(MStringCase),
            typeof(Case1)
        },
    ...
    public abstract class SelfMailerEditableTo
    {
        ...
        /// </summary>
        /// <returns>
        /// The SelfMailerEditableTo instance, wrapping the provided string value.
        /// </returns>
        public static SelfMailerEditableTo FromString(string mString)
        {
        ...
        /// </summary>
        /// <returns>
        /// The SelfMailerEditableTo instance, wrapping the provided InlineAddress value.
        /// </returns>
        ...
        private sealed class MStringCase : SelfMailerEditableTo, ICaseValue<MStringCase, string>
        {
        ...
        private sealed class Case1 : SelfMailerEditableTo, ICaseValue<Case1, InlineAddress>
        {
