...
namespace Lob.Standard.Models.Containers
{
    ...
    /// </summary>
    [JsonConverter(
        typeof(UnionTypeConverter<WordsatcheckbottomFrom>),
        new Type[] {
            typeof(MStringCase),
    ...
    public abstract class WordsatcheckbottomFrom
    {
        /// <summary>
        /// This is String case.
        /// </summary>
        /// <returns>
        /// The WordsatcheckbottomFrom instance, wrapping the provided string value.
        /// </returns>
        public static WordsatcheckbottomFrom FromString(string mString)
        {
        ...
        /// </summary>
        /// <returns>
        /// The WordsatcheckbottomFrom instance, wrapping the provided InlineAddressUs value.
        /// </returns>
        public static WordsatcheckbottomFrom FromInlineAddressUs(InlineAddressUs inlineAddressUs)
        {
        ...
        private sealed class MStringCase : WordsatcheckbottomFrom, ICaseValue<MStringCase, string>
        {
        ...
        private sealed class InlineAddressUsCase : WordsatcheckbottomFrom, ICaseValue<InlineAddressUsCase, InlineAddressUs>
        {
