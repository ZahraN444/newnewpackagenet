...
namespace Lob.Standard.Models.Containers
{
    ...
    /// </summary>
    [JsonConverter(
        typeof(UnionTypeConverter<InputFromFrom>),
        new Type[] {
            typeof(MStringCase),
            typeof(Case1)
        },
    ...
    public abstract class InputFromFrom
    {
        /// <summary>
        /// This is String case.
        /// </summary>
        /// <returns>
        /// The InputFromFrom instance, wrapping the provided string value.
        /// </returns>
        public static InputFromFrom FromString(string mString)
        {
        ...
        /// </summary>
        /// <returns>
        /// The InputFromFrom instance, wrapping the provided InlineAddress value.
        /// </returns>
        public static InputFromFrom FromInlineAddress(InlineAddress inlineAddress)
        {
        ...
        private sealed class MStringCase : InputFromFrom, ICaseValue<MStringCase, string>
        {
        ...
        private sealed class Case1 : InputFromFrom, ICaseValue<Case1, InlineAddress>
        {
