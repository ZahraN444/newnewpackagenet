...
namespace Lob.Standard.Models.Containers
{
    ...
    /// </summary>
    [JsonConverter(
        typeof(UnionTypeConverter<InputFromUsFrom>),
        new Type[] {
            typeof(MStringCase),
    ...
    public abstract class InputFromUsFrom
    {
        /// <summary>
        /// This is String case.
        /// </summary>
        /// <returns>
        /// The InputFromUsFrom instance, wrapping the provided string value.
        /// </returns>
        public static InputFromUsFrom FromString(string mString)
        {
        ...
        /// </summary>
        /// <returns>
        /// The InputFromUsFrom instance, wrapping the provided InlineAddressUs value.
        /// </returns>
        public static InputFromUsFrom FromInlineAddressUs(InlineAddressUs inlineAddressUs)
        {
        ...
        private sealed class MStringCase : InputFromUsFrom, ICaseValue<MStringCase, string>
        {
        ...
        private sealed class InlineAddressUsCase : InputFromUsFrom, ICaseValue<InlineAddressUsCase, InlineAddressUs>
        {
