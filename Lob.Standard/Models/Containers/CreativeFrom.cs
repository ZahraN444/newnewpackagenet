...
namespace Lob.Standard.Models.Containers
{
    ...
    /// </summary>
    [JsonConverter(
        typeof(UnionTypeConverter<CreativeFrom>),
        new Type[] {
            typeof(MStringCase),
    ...
    public abstract class CreativeFrom
    {
        /// <summary>
        /// This is String case.
        /// </summary>
        /// <returns>
        /// The CreativeFrom instance, wrapping the provided string value.
        /// </returns>
        public static CreativeFrom FromString(string mString)
        {
        ...
        /// </summary>
        /// <returns>
        /// The CreativeFrom instance, wrapping the provided InlineAddressUs value.
        /// </returns>
        public static CreativeFrom FromInlineAddressUs(InlineAddressUs inlineAddressUs)
        {
        ...
        private sealed class MStringCase : CreativeFrom, ICaseValue<MStringCase, string>
        {
        ...
        private sealed class InlineAddressUsCase : CreativeFrom, ICaseValue<InlineAddressUsCase, InlineAddressUs>
        {
