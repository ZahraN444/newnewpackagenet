...
namespace Lob.Standard.Models.Containers
{
    ...
    /// </summary>
    [JsonConverter(
        typeof(UnionTypeConverter<InputToTo>),
        new Type[] {
            typeof(MStringCase),
            typeof(Case1)
        },
    ...
    public abstract class InputToTo
    {
        /// <summary>
        /// This is String case.
        /// </summary>
        /// <returns>
        /// The InputToTo instance, wrapping the provided string value.
        /// </returns>
        public static InputToTo FromString(string mString)
        {
        ...
        /// </summary>
        /// <returns>
        /// The InputToTo instance, wrapping the provided InlineAddress value.
        /// </returns>
        public static InputToTo FromInlineAddress(InlineAddress inlineAddress)
        {
        ...
        private sealed class MStringCase : InputToTo, ICaseValue<MStringCase, string>
        {
        ...
        private sealed class Case1 : InputToTo, ICaseValue<Case1, InlineAddress>
        {
